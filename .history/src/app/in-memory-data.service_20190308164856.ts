...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    const heroes = [
      { id: 11, name: 'Alcancias',tag:'stuff',imagen:'azulconpuntos1.png',productos:[
      ...
      { id: 12, name: 'Materas' ,tag:'stuff',imagen:'elefaneazul1.jpeg',productos:[
      ...
      { id: 14, name: 'Otros' ,tag:'stuff',imagen:'skull.jpg',productos:[
