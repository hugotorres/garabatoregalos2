...
export class CategoriaService {
  ...
  addCategoria (categoria: Categoria): Observable<Hero> {
    return this.http.post<Hero>(this.categoriasUrl, hero, httpOptions).pipe(
      tap((newCategoria: Categoria) => this.log(`added categoria w/ id=${newHero.id}`)),
